...
export default function HeroSection() {
  ...
  const staticContent = useMemo(
    () => (
      <div className="h-full flex flex-col items-center justify-between gap-20 relative z-10 pointer-events-auto">
        <Image
          src="/BERBARTOS.webp"
          alt="HeroSectionText"
          width={500}
  ...
  return (
    ...
    >
      <div
        className={`${styles.customPagination} absolute top-10 left-0 right-0 z-30`}
      ></div>
              ...
              {slide.type === "image" ? (
                ...
                >
                  <video
                    ...
                    playsInline
                    preload="none" // Giữ metadata để lấy thông tin nhanh
                  ...
                  <div
                    className="absolute inset-x-0 top-0 h-[100px] bg-gradient-to-b from-black/10 to-transparent z-10 pointer-events-none"
                    aria-hidden="true"
                  ></div>

                  {/* Bottom Inset Shadow Overlay */}
                  <div
                    className="absolute inset-x-0 bottom-0 h-[100px] bg-gradient-to-t from-black/70 to-transparent z-10 pointer-events-none"
                    aria-hidden="true"
                  ></div>
                        ...
                        <>
                          ...
                          >
                            ...
                            >
                              <path
                                fillRule="evenodd"
                                d="M4.5 5.653c0-1.426 1.529-2.33 2.779-1.643l11.54 6.347c1.295.712 1.295 2.573 0 3.286L7.28 19.99c-1.25.687-2.779-.217-2.779-1.643V5.653Z"
                                clipRule="evenodd"
                              />
      ...
      <div className="absolute inset-0 z-20 flex flex-col items-center justify-center px-4 text-center pointer-events-none">
        ...
        <div className="pointer-events-none">{staticContent}</div>
      </div>
    </section>
  );
}
